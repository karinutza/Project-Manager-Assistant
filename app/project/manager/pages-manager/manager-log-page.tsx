...
export default function HomeScreen() {
  ...
  const renderProject = ({ item }: { item: any }) => (
    <Link href={`/project/manager/pages-manager/project-page-manager?id=${item.id}`} asChild>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      try {
                        ...
                        router.push({ pathname: "/project/manager/pages-manager/departments-page", params: { department: item, projects: payload } } as any);
                      } catch {
                        router.push({ pathname: "/project/manager/pages-manager/departments-page", params: { department: item } } as any);
                      }
                    }}
                  >
              ...
              <Calendar
                onDayPress={(day) => {
                  ...
                  try {
                    ...
                    router.push({ pathname: "/project/manager/pages-manager/calendar-deadlines-page", params: { date, projects: payload } } as any);
                  } catch {
                    router.push({ pathname: "/project/manager/pages-manager/calendar-deadlines-page", params: { date } } as any);
                  }
                }}
