    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.content}>
          <TouchableOpacity style={styles.backButton} onPress={() => router.push("/project/manager/pages-manager/manager-log-page")}>
          ...
          <ScrollView style={styles.scroll} nestedScrollEnabled>
            ...
            <View style={styles.cardOverview}>
              ...
              <TouchableOpacity
                onPress={() => {
                  try {
                    ...
                    router.push({
                      pathname: "/project/manager/pages-manager/analytics-page",
                      params: { id: project.id, tasks: payload },
                    } as any);
                  } catch (e) {
                    router.push(("/project/manager/pages-manager/analytics-page" as unknown) as any);
                  }
                }}
                activeOpacity={0.9}
              >
              ...
              <TouchableOpacity
                onPress={() => router.push("/project/manager/pages-manager/microsoft-assistant-page")
}
                activeOpacity={0.9}
              >
                <LinearGradient
