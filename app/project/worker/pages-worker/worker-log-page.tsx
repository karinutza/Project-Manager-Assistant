            ...
            <View style={styles.summarySection}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <Link href={`/project/worker/pages-worker/analytics-page-worker?projectId=${item.id}`} asChild>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      try {
                        ...
                        router.push({ pathname: "/project/worker/pages-worker/departments-page-worker", params: { department: item, projects: payload } } as any);
                      } catch {
                        router.push({ pathname: "/project/worker/pages-worker/departments-page-worker", params: { department: item } } as any);
                      }
                    }}
                  >
              ...
              <Calendar
                onDayPress={(day) => {
                  ...
                  try {
                    ...
                    router.push({ pathname: "/project/worker/pages-worker/calendar-deadlines-page-worker", params: { date, projects: payload } } as any);
                  } catch {
                    router.push({ pathname: "/project/worker/pages-worker/calendar-deadlines-page-worker", params: { date } } as any);
                  }
                }}
